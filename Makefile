...
coverage: clean test ## generate and view HTML coverage report
	coverage html
...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint openedx_atlas tests *.py
	rm tests/__init__.py
	pycodestyle openedx_atlas tests  *.py
	pydocstyle openedx_atlas tests *.py
